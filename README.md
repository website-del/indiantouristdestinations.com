...
<head>
    ...
    <title>Discover India - Tourism Guide</title>
    <style>
        body {
        ...
        .destinations, .culture, .adventure {
            display: flex;
            flex-wrap: wrap;
            justify-content: space-around;
        }
        .destination, .culture-item, .adventure-item {
            width: 30%;
            margin: 15px 0;
        }
        .destination img, .culture-item img, .adventure-item img {
            width: 100%;
            height: 200px;
            object-fit: cover;
        }
        .destination h3, .culture-item h3, .adventure-item h3 {
            text-align: center;
            margin-top: 10px;
        }
        footer {
